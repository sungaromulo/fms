...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-lg-12">
			<div class="col-md-2 input-group offset-10">
		...
		<div class="row">
			...
			?>
				<div class="card col-md-2 mt-3 ml-3 mr-3 mb-3 folder-item" data-id="<?php echo $row['id'] ?>">
					<div class="card-body">
		...
		<hr>
		<h9>Note: Only Image and PDF file visible to view at this moment.</h9>
		<hr>
		...
		<div class="row1">
			<div class="card col-md-12">
				<div class="card-body">
						...
						<tr>						
							<th width="40%"><font color="blue">FILENAME</th></font>
							<th width="40%"><font color="blue">DATE</th></font>
							<th width="40%"><font color="blue">DESCRIPTION</th></font>
							<th width="40%"><font color="blue">VIEW</th></font>
						</tr>
			</div>
					...
					?>
						<tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
							...
							<td><a href="assets/uploads/".$fname<?php echo  $name; ?>"><button class='btn btn-sm btn-outline-primary' value='' ><i class="fas fa-eye"></i></button></a>
						</tr>
...
<div id="menu-folder-clone" style="display: none;">
	...
	<a href="javascript:void(0)" class="custom-menu-list file-option download">Download</a>
</div>
...
<script>
	...
	$("div.custom-menu .download").click(function(e){
		e.preventDefault()
		_conf("Are you sure want to download this folder?",'download.php?id=<?php echo $folder_parent ?>&id='+$(this).attr('data-id'))
	})
})
